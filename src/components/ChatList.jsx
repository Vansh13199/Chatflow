    ...
    <div className="flex flex-col flex-1 w-full bg-white dark:bg-gray-900">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar">
        ...
        {users.length === 0 ? (
          ...
          users.map((user) => {
            const msgs = Array.isArray(conversations[user]) ? conversations[user] : [];
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex justify-between items-center mb-1">
                    ...
                    {lastMsg && <span className="text-xs text-gray-400 whitespace-nowrap ml-2">{new Date(lastMsg.timestamp || Date.now()).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', hour12: true })}</span>}
                  </div>
